...
CREATE FUNCTION auditing.if_modified_func() RETURNS trigger
  ...
  BEGIN
    ...
    EXECUTE 'CREATE TABLE IF NOT EXISTS auditing.logged_actions_' || quote_ident(TG_TABLE_NAME::TEXT) || '(
      CHECK (table_name = ' || quote_literal(TG_TABLE_NAME::TEXT) || ')
    ) INHERITS (auditing.logged_actions)';

    EXECUTE 'INSERT INTO auditing.logged_actions_' || quote_ident(TG_TABLE_NAME::TEXT) || ' VALUES ($1.*)' USING audit_row;
    RETURN NULL;
  END;
$_$;
...
--
-- Name: logged_actions_admin_users; Type: TABLE; Schema: auditing; Owner: -
--

CREATE TABLE auditing.logged_actions_admin_users (
...
--
-- Name: old_logged_actions; Type: TABLE; Schema: auditing; Owner: -
--

CREATE TABLE auditing.old_logged_actions (
    event_id bigint NOT NULL,
    schema_name text NOT NULL,
    table_name text NOT NULL,
    relid oid NOT NULL,
...
--
-- Name: TABLE old_logged_actions; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON TABLE auditing.old_logged_actions IS 'History of auditable actions on audited tables, from auditing.if_modified_func()';


--
-- Name: COLUMN old_logged_actions.event_id; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.event_id IS 'Unique identifier for each auditable event';


--
-- Name: COLUMN old_logged_actions.schema_name; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.schema_name IS 'Database schema audited table for this event is in';


--
-- Name: COLUMN old_logged_actions.table_name; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.table_name IS 'Non-schema-qualified table name of table event occured in';


--
-- Name: COLUMN old_logged_actions.relid; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.relid IS 'Table OID. Changes with drop/create. Get with ''tablename''::regclass';


--
-- Name: COLUMN old_logged_actions.session_user_name; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.session_user_name IS 'Login / session user whose statement caused the audited event';


--
-- Name: COLUMN old_logged_actions.app_user_id; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.app_user_id IS 'Application-provided polymorphic user id';


--
-- Name: COLUMN old_logged_actions.app_user_type; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.app_user_type IS 'Application-provided polymorphic user type';


--
-- Name: COLUMN old_logged_actions.app_ip_address; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.app_ip_address IS 'Application-provided ip address of user whose statement caused the audited event';


--
-- Name: COLUMN old_logged_actions.action_tstamp_tx; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.action_tstamp_tx IS 'Transaction start timestamp for tx in which audited event occurred';


--
-- Name: COLUMN old_logged_actions.action_tstamp_stm; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.action_tstamp_stm IS 'Statement start timestamp for tx in which audited event occurred';


--
-- Name: COLUMN old_logged_actions.action_tstamp_clk; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.action_tstamp_clk IS 'Wall clock time at which audited event''s trigger call occurred';


--
-- Name: COLUMN old_logged_actions.transaction_id; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.transaction_id IS 'Identifier of transaction that made the change. May wrap, but unique paired with action_tstamp_tx.';


--
-- Name: COLUMN old_logged_actions.application_name; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.application_name IS 'Application name set when this audit event occurred. Can be changed in-session by client.';


--
-- Name: COLUMN old_logged_actions.client_addr; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.client_addr IS 'IP address of client that issued query. Null for unix domain socket.';


--
-- Name: COLUMN old_logged_actions.client_port; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.client_port IS 'Remote peer IP port address of client that issued query. Undefined for unix socket.';


--
-- Name: COLUMN old_logged_actions.client_query; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.client_query IS 'Top-level query that caused this auditable event. May be more than one statement.';


--
-- Name: COLUMN old_logged_actions.action; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.action IS 'Action type; I = insert, D = delete, U = update, T = truncate';


--
-- Name: COLUMN old_logged_actions.row_id; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.row_id IS 'Record primary_key. Null for statement-level trigger. Prefers NEW.id if exists';


--
-- Name: COLUMN old_logged_actions.row_data; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.row_data IS 'Record value. Null for statement-level trigger. For INSERT this is the new tuple. For DELETE and UPDATE it is the old tuple.';


--
-- Name: COLUMN old_logged_actions.changed_fields; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.changed_fields IS 'New values of fields changed by UPDATE. Null except for row-level UPDATE events.';


--
-- Name: COLUMN old_logged_actions.statement_only; Type: COMMENT; Schema: auditing; Owner: -
--

COMMENT ON COLUMN auditing.old_logged_actions.statement_only IS '''t'' if audit event is from an FOR EACH STATEMENT trigger, ''f'' for FOR EACH ROW';
...
ALTER SEQUENCE auditing.logged_actions_event_id_seq OWNED BY auditing.old_logged_actions.event_id;
...
ALTER SEQUENCE auditing.logged_actions_event_id_seq1 OWNED BY auditing.logged_actions.event_id;
...
ALTER TABLE ONLY auditing.logged_actions ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);
...
ALTER TABLE ONLY auditing.logged_actions_active_admin_comments ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);


--
-- Name: logged_actions_active_storage_attachments event_id; Type: DEFAULT; Schema: auditing; Owner: -
--

ALTER TABLE ONLY auditing.logged_actions_active_storage_attachments ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);


--
-- Name: logged_actions_active_storage_blobs event_id; Type: DEFAULT; Schema: auditing; Owner: -
--

ALTER TABLE ONLY auditing.logged_actions_active_storage_blobs ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);


--
-- Name: logged_actions_admin_users event_id; Type: DEFAULT; Schema: auditing; Owner: -
--

ALTER TABLE ONLY auditing.logged_actions_admin_users ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);
...
ALTER TABLE ONLY auditing.logged_actions_clients ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);
...
ALTER TABLE ONLY auditing.logged_actions_developers ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);
...
ALTER TABLE ONLY auditing.logged_actions_tasks ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq1'::regclass);
...
ALTER TABLE ONLY auditing.old_logged_actions ALTER COLUMN event_id SET DEFAULT nextval('auditing.logged_actions_event_id_seq'::regclass);
...
--
-- Name: old_logged_actions logged_actions_pkey; Type: CONSTRAINT; Schema: auditing; Owner: -
--
...
--
-- Name: logged_actions logged_actions_pkey1; Type: CONSTRAINT; Schema: auditing; Owner: -
--
...
CREATE INDEX logged_actions_action_idx ON auditing.old_logged_actions USING btree (action);
...
CREATE INDEX logged_actions_action_tstamp_tx_stm_idx ON auditing.old_logged_actions USING btree (action_tstamp_stm);
...
CREATE INDEX logged_actions_relid_idx ON auditing.old_logged_actions USING btree (relid);
...
CREATE INDEX logged_actions_row_id_idx ON auditing.old_logged_actions USING btree (row_id);
